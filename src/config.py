...
from src.domain.constants import DELIVERY_FAILURE_REASONS, INDIA_BOUNDS, SHIPMENT_EVENT_TYPES
...
SHIPMENT_CONFIG = {
    ...
    # Events
    "valid_event_types": list(SHIPMENT_EVENT_TYPES),
}
...
DELIVERY_CONFIG = {
    ...
    # Failure reasons
    "failure_reasons": list(DELIVERY_FAILURE_REASONS),
}
...
WAREHOUSE_CONFIG = {
    ...
    # No hardcoded fallback secret; set POSTGRES_PASSWORD in environment.
